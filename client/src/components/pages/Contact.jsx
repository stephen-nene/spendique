...
export default function Contact() {
  return (
    <>
<div className=" grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-5xl bg-white font-[sans-serif]">
            <div>
                ...
                <div className="mt-12">
                    ...
                    <ul className="mt-4">
                        <li className="flex items-center">
                            ...
                            <a target='_blank_' href="mailto:stevekid705@gmail.com" className="text-[#007bff] text-sm ml-4">
                                <small className="block">Talk to me</small>
                                <strong>stevekid705@gmail.com</strong>
                            </a>
                        </li>
                    </ul>
                </div>
